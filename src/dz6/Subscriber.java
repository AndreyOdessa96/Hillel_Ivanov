...
public class Subscriber {
    ...
    public Subscriber(int id, String lastName, String firstName, String city, String phoneNumber, int contractNumber, double balance, int cityCallDuration, int interCityCallDuration, double internetTraffic) {
        this.id = id;
    ...
    public String toString() {
        return "Subscriber{" + "id=" + id + ", lastName='" + lastName + '\'' + ", firstName='" + firstName + '\'' + ", city='" + city + '\'' + ", phoneNumber='" + phoneNumber + '\'' + ", contractNumber=" + contractNumber + ", balance=" + balance + ", cityCallDuration=" + cityCallDuration + ", interCityCallDuration=" + interCityCallDuration + ", internetTraffic=" + internetTraffic + '}';
    }
}